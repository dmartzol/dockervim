...
vim.api.nvim_set_keymap("n", "<Left>", ":bN<CR>", opts)

-- Page up and down with arrows
vim.api.nvim_set_keymap("n", "<Up>", "<C-u>", opts)
vim.api.nvim_set_keymap("n", "<Down>", "<C-d>", opts)
vim.api.nvim_set_keymap("v", "<Up>", "<C-u>", opts)
vim.api.nvim_set_keymap("v", "<Down>", "<C-d>", opts)
