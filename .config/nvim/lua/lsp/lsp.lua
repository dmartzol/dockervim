...
local on_attach = function(client, bufnr)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, 'n', 'gd', '<Plug>(go-def)<CR>', silent)
    ...
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>lb', '<cmd>GoBuild<CR>', norep)
    vim.api.nvim_buf_set_keymap(bufnr, 'n', '<leader>lt', '<cmd>GoTest<CR>', norep)
end
